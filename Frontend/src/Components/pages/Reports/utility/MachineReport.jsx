      ...
      >
        <CTableHead>
          <CTableRow>
            ...
            <CTableHeaderCell scope="col">Machine Count</CTableHeaderCell>
            <CTableHeaderCell scope="col">Machine Running</CTableHeaderCell>
            <CTableHeaderCell scope="col">Machine Down</CTableHeaderCell>
          </CTableRow>
        </CTableHead>
        <CTableBody>
          {reportData && reportData.length > 0 ? (
            reportData.map((data, index) => (
              ...
              >
                ...
                <CTableDataCell>{data.running}</CTableDataCell>
                <CTableDataCell>{data.down}</CTableDataCell>
              </CTableRow>
            ))
          ) : (
            <CTableRow>
